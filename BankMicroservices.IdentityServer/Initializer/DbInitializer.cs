...
namespace BankMicroservices.IdentityServer.Initializer
{
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            ApplicationUser admin = new ApplicationUser()
            {
                ...
                Email = "cesar-admin@teste.com.br",
                EmailConfirmed = true,
            ...
            _user.CreateAsync(admin, "Cesar123$").GetAwaiter().GetResult();
            ...
            {
                UserName = "cesar-client",
                Email = "cesar-client@teste.com.br",
                EmailConfirmed = true,
                PhoneNumber = "+55 (34) 12345-6789",
                FirstName = "Cesar",
                LastName = "Client"
            ...
            _user.CreateAsync(client, "Cesar123$").GetAwaiter().GetResult();
